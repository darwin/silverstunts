...
namespace Physics.Surfaces
{
    ...
    public interface ISurface
    {
        ...
        void ResolveCircleCollision(CircleParticle p, Engine engine);
        void ResolveRectangleCollision(RectangleParticle p, Engine engine);

        bool IsRectangleColliding(RectangleParticle p);
    }
}
