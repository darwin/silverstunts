...
namespace Physics.Primitives
{
	...
	public interface IParticle
	{
		...
		void ResolveCircleCollision( CircleParticle p, Engine engine, ref CollisionState state );
		void ResolveRectangleCollision( RectangleParticle p, Engine engine, ref CollisionState state );
	}
}
